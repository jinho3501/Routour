                  ...
                  child: Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            _isAddressLiked = !_isAddressLiked;
                            // TODO: 여기서 DB 저장/제거 로직도 호출
                          });
                        },
                        child: Icon(
                          _isAddressLiked ? Icons.favorite : Icons.favorite_border,
                          color: _isAddressLiked ? Colors.red : Colors.black54,
                          size: 24,
                        ),
                      ),
                    ],
